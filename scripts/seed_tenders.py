...
CATEGORIES_DATA = [
    (
        ...
        [
            ...
            "Machine Learning Platform for Smart City",
            "AI Chatbot for Citizen Services",
            "NLP System for Legal Document Analysis",
        ],
    ),
    (
        "Cybersecurity",
        [
            "SOC Setup and Management Services",
    ...
    (
        "Drone",
        [
            "Drone-based Survey and Mapping",
            "Agricultural Spraying Drones",
            "Border Surveillance Drone System",
            "Traffic Monitoring Drone Fleet",
        ],
    ),
    (
        "Construction",
        [
            "Government Office Complex Construction",
            "Road Widening Works",
            "Bridge Construction",
    ...
    (
        ...
        [
            ...
            "Rooftop Solar for Government Schools",
        ],
    ),
    (
        "Cloud",
        [
            "Cloud Infrastructure Services for Government",
            "GI Cloud Expansion",
    ...
    (
        "IoT",
        [
            "Smart Street Lighting IoT Solution",
    ...
    (
        "Medical Equipment",
        [
            "MRI Machine 3T Procurement",
            "CT Scanner Procurement",
    ...
    (
        ...
        [
            ...
            "City-wide Wi-Fi Infrastructure",
    ...
    (
        "GIS",
        [
            "GIS Mapping for Land Records",
            "Urban Planning GIS Platform",
            "Satellite Image Procurement",
            "Property Tax GIS Integration",
        ],
    ),
    (
        "Education",
    ...
    (
        "Defence",
        [
            "Bullet Proof Vehicles Procurement",
            "Communication Equipment",
            "Night Vision Devices Procurement",
    ...
    for t in tenders:
        try:
            await conn.execute(
                ...
                t["state"],
                t["categories"],
                t["estimated_cost_lakhs"],
                t["emd_lakhs"],
                t["tender_fee"],
                t["performance_guarantee_pct"],
                ...
                t["opening_date"],
                t["bid_validity_days"],
                t["work_completion_days"],
                t["turnover_min_lakhs"],
                t["experience_years"],
                t["certifications_required"],
                t["msme_eligible"],
                t["startup_eligible"],
                t["ai_summary"],
                t["ai_extraction_tier"],
