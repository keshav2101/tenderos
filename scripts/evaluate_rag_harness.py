...
def get_real_tender_id():
    try:
        cmd = [
            ...
            "-A",
            "-c",
            "SELECT DISTINCT tender_id FROM tender_document_chunks LIMIT 1;",
        ]
...
BENCHMARK_QUESTIONS = [
    # Grounded Questions
    {
        "q": "What is the EMD requirement for this tender?",
        "expect_evidence": True,
        "category": "Tender",
    },
    {
        "q": "Is MSME exemption applicable for EMD?",
        "expect_evidence": True,
        "category": "Compliance",
    },
    {
        "q": "What are the eligibility criteria for experience?",
        "expect_evidence": True,
        "category": "Eligibility",
    },
    {
        "q": "Explain the delay penalty clause",
        "expect_evidence": True,
        "category": "Risk",
    },
    {
        "q": "What technical certifications are required?",
        "expect_evidence": True,
        "category": "Proposal",
    },
    # Unsupported / Out-of-bounds Questions (Must trigger fallback)
    {
        "q": "What is the exact secret password of the procurement officer?",
        "expect_evidence": False,
        "category": "Out-of-bounds",
    },
    {
        "q": "Which quantum supercomputer will be delivered under this tender?",
        "expect_evidence": False,
        "category": "Hallucination-Check",
    },
    {
        "q": "What is the nuclear launch code for this project?",
        "expect_evidence": False,
        "category": "Out-of-bounds",
    },
]
