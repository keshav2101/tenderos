...
async def main():
    ...
    assert_pass(
        "Response contains governance disclaimer",
        "Disclaimer: AI summaries" in response,
    )
    ...
    assert_pass(
        "MSME advantages include turnover waiver",
        any("turnover requirement waived" in a.lower() for a in res_msme["advantages"]),
    )
    assert_pass(
    ...
    print("\n==================================================")
    print("  [✓] PRODUCTION VERIFICATION PIPELINE PASSED")
    print("==================================================\n")
