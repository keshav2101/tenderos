...
def get_last_crawl(source_id: str) -> datetime | None:
...
def set_last_crawl(source_id: str, ts: datetime | None = None):
...
def should_archive(submission_deadline: datetime | None, grace_days: int = 7) -> bool:
    """
...
def compute_since_delta(source_id: str, default_days_back: int = 3) -> datetime | None:
    """
